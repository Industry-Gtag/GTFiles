...
public class VRRig : MonoBehaviour, IWrappedSerializable, INetworkStruct, IPreDisable, IUserCosmeticsCallback, IGorillaSliceableSimple, ITickSystemPost, IEyeScannable
{
	...
	public void SetQuestScore(int score)
	{
		...
		OnQuestScoreChanged?.Invoke(currentQuestScore);
		if (netView != null)
		{
			netView.SendRPC("RPC_UpdateQuestScore", RpcTarget.Others, currentQuestScore);
		}
	...
	private bool LocalTestMovementCollision(Vector3 startPosition, Vector3 startVelocity, out Vector3 modifiedVelocity, out Vector3 finalPosition)
	{
		...
		bool num = LocalCheckCollision(startPosition, vector, instance.headCollider.radius * scaleFactor, out var finalPosition2, out var hit);
		if (num)
		{
		...
		bool flag = LocalCheckCollision(position, vector, instance.minimumRaycastDistance * scaleFactor, out var finalPosition3, out var _);
		if (flag)
		{
		...
		bool flag2 = LocalCheckCollision(position2, vector, instance.minimumRaycastDistance * scaleFactor, out var finalPosition4, out var _);
		if (flag2)
		{
