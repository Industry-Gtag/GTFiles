...
internal class MockWarningServer : WarningsServer
{
	...
	// (get) Token: 0x06004AD9 RID: 19161 RVA: 0x0018FB20 File Offset: 0x0018DD20
	...
	// Token: 0x06004ADA RID: 19162 RVA: 0x0018FB38 File Offset: 0x0018DD38
	private void Awake()
	{
	...
	// Token: 0x06004ADB RID: 19163 RVA: 0x0018FB58 File Offset: 0x0018DD58
	private PlayerAgeGateWarningStatus CreateWarningStatus(string header, string body, MockWarningServer.ButtonSetup? leftButtonSetup, MockWarningServer.ButtonSetup? rightButtonSetup, EImageVisibility showImage, Action leftButtonCallback, Action rightButtonCallback)
	{
		...
		playerAgeGateWarningStatus.noWarningResult = WarningButtonResult.None;
	...
	// Token: 0x06004ADC RID: 19164 RVA: 0x0018FC20 File Offset: 0x0018DE20
			...
			else
			{
				...
				case 4:
					...
					else
					{
						...
						playerAgeGateWarningStatus2.noWarningResult = WarningButtonResult.Continue;
					}
					break;
				case 5:
					playerAgeGateWarningStatus2 = this.CreateWarningStatus("", "", null, null, EImageVisibility.None, null, null);
	...
	// Token: 0x06004ADD RID: 19165 RVA: 0x0018FC6C File Offset: 0x0018DE6C
	...
	// Token: 0x06004ADE RID: 19166 RVA: 0x0018FCB8 File Offset: 0x0018DEB8
	...
	{
		// Token: 0x06004AE0 RID: 19168 RVA: 0x0018FD0D File Offset: 0x0018DF0D
