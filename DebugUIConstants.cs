...
public static class DebugUIConstants
{
	...
	public static readonly string[] GameModes = new string[] { "HUNT", "PAINTBRAWL", "CASUAL", "INFECTION" };

	// Token: 0x04003097 RID: 12439
	public static readonly string[] PlayerNames = new string[] { "GorillaUser1", "GorillaUser2", "GorillaUser3", "GorillaUser4", "GorillaUser5" };
}
