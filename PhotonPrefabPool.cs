...
public class PhotonPrefabPool : MonoBehaviour, IPunPrefabPoolVerify, IPunPrefabPool, ITickSystemPre
{
	...
	// (get) Token: 0x060036C0 RID: 14016 RVA: 0x0012DB5E File Offset: 0x0012BD5E
	// (set) Token: 0x060036C1 RID: 14017 RVA: 0x0012DB66 File Offset: 0x0012BD66
	bool ITickSystemPre.PreTickRunning { get; set; }

	// Token: 0x060036C2 RID: 14018 RVA: 0x0012DB6F File Offset: 0x0012BD6F
	private void Awake()
	{
		RoomSystem.LeftRoomEvent += new Action(this.OnLeftRoom);
	}

	// Token: 0x060036C3 RID: 14019 RVA: 0x0012DB8C File Offset: 0x0012BD8C
	private void Start()
	{
	...
	// Token: 0x060036C4 RID: 14020 RVA: 0x0012DC18 File Offset: 0x0012BE18
	...
	// Token: 0x060036C5 RID: 14021 RVA: 0x0012DCF8 File Offset: 0x0012BEF8
	...
	// Token: 0x060036C6 RID: 14022 RVA: 0x0012DD38 File Offset: 0x0012BF38
	...
	// Token: 0x060036C7 RID: 14023 RVA: 0x0012DD68 File Offset: 0x0012BF68
	...
	// Token: 0x060036C8 RID: 14024 RVA: 0x0012DE28 File Offset: 0x0012C028
	...
	// Token: 0x060036C9 RID: 14025 RVA: 0x0012DEEC File Offset: 0x0012C0EC
	...
	// Token: 0x060036CA RID: 14026 RVA: 0x0012DF5C File Offset: 0x0012C15C
	private void CheckVOIPSettings(RemoteVoiceLink voiceLink)
	{
		try
		{
			...
			if (netPlayer != null)
			{
				...
				{
					rigContainer.SetMuted(RigContainer.MuteReason.OversizedStream, true);
				}
			}
		}
		catch (Exception ex)
